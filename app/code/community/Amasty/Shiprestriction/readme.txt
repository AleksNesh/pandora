...
3) copy files from 'Step1' folder to the magento root folder

4) copy files from 'Step2' folder to the magento root folder	
...
1. Open file app/etc/modules/Amasty_Shiprestriction.xml, find this line of code:
