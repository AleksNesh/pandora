...
3) copy files from 'Step_1' folder to the magento root folder

4) copy files from 'Step_2' folder to the magento root folder	
...
1. Open file app/etc/modules/Amasty_Promo.xml, find this line of code:
