 ...
 */
class TinyBrick_Authorizenetcim_Model_Mysql4_Authorizenetcim extends Mage_Core_Model_Mysql4_Abstract
{
	
	public function _construct()
	{
		$this->_init('authorizenetcim/authorizenetcim', 'tinybrick_authorizenetcim_ccsave_id');
	}
}