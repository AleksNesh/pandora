 ...
 */
class TinyBrick_Authorizenetcim_Block_Ccedit extends Mage_Directory_Block_Data
{
    protected $_address;
    ...
    */
    ...
    public function getBillingAddressCim()
    {
    	/**
    	 * This will contact Authorize.net and get the current billing address
    	 */
    	$profileId = $this->getCcInfo()->getTokenProfileId();
    	$paymentId = $this->getCcInfo()->getTokenPaymentProfileId();
    	$cim = Mage::getModel('authorizenetcim/authorizenetcimsoap');
    	$billing = $cim->getCustomerPaymentProfileRequest($profileId, $paymentId);
    	return $billing;
    }
}