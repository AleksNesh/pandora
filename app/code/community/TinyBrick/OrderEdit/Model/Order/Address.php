...
class TinyBrick_OrderEdit_Model_Order_Address extends Mage_Sales_Model_Order_Address
{
    ...
    /** 
     * Before saving, sets the order id
    ...
    /**
     * Checks order to see if there are items
     * @return int
     */
    ...
    /**
     * Gets the items of the order by the order item id
     * @param int $itemId
     * @return object 
     */
    ...
    public function recalculateShippingRates($order,$params = null)
	{
        ...
        ? $item[0]->getBaseRowTotal() - $item[0]->getBaseDiscountAmount()
