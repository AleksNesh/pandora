...
class MageWorx_OrdersPro_Model_Mysql4_Order_Grid_Collection extends MageWorx_OrdersPro_Model_Mysql4_Order_Grid_Collection_Abstract
{
    ...
    public function setOrderItemTbl() {                      
        if ($this->getSelect()!==null && !isset($this->_setFields['setOrderItemTbl'])) {
            ...
            if (in_array('order_comment', Mage::helper('mageworx_orderspro')->getGridColumns())) $this->getSelect()->group('main_table.entity_id');
...
//    }
    ...
    public function setShipmentTrackTbl() {              
        if ($this->getSelect()!==null && !isset($this->_setFields['setShipmentTrackTbl'])) {
            if (version_compare(Mage::helper('mageworx_orderspro')->getMagetoVersion(), '1.6.0', '>=')) {
