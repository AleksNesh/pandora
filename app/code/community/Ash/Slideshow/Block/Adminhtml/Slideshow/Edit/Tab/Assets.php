...
class Ash_Slideshow_Block_Adminhtml_Slideshow_Edit_Tab_Assets extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * $_helper
    ...
    protected function _prepareCollection()
    {
        ...
        {
            $collection->getSelect()->joinLeft(array('t2' => 'ash_slideshow_slideshow_assets' ), 'main_table.id = t2.asset_id and t2.slide_id='.$slideId, 't2.asorder');
        }
        else
        {
            $collection->getSelect()->distinct(true);
            $collection->getSelect()->group('asset_id');
            $collection->getSelect()->joinLeft(array('t2' => 'ash_slideshow_slideshow_assets' ), 'main_table.id = t2.asset_id', 't2.asorder');
        }
