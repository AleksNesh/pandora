...
class Ash_Slideshow_Block_Adminhtml_Slideshow_New_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    /**
     * $_helper
    ...
    protected function _beforeToHtml()
    {
        $this->addTab('form_section_info', array(
            ...
            'content'   => $this->getLayout()->createBlock('ash_slideshow/adminhtml_slideshow_new_tab_form')->toHtml(),
        ));

        $this->addTab('form_section_settings', array(
            'label'     => $this->_helper->__('Settings'),
            'title'     => $this->_helper->__('Settings'),
            'content'   => $this->getLayout()->createBlock('ash_slideshow/adminhtml_slideshow_new_tab_settings')->toHtml(),
        ));

        $this->addTab('form_section_assets', array(
            'label'     => $this->_helper->__('Assets'),
            'title'     => $this->_helper->__('Assets'),
            'content'   => $this->getLayout()->createBlock('ash_slideshow/adminhtml_slideshow_new_tab_assets')->toHtml(),
        ));
