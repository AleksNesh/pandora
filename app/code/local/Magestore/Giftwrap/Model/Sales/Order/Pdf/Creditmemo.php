           ...
           // var_dump($this->y);die();
            ...
            if (count($giftwrapItems)) {
                ...
                foreach ($giftwrapItems as $giftwrapItem) {	
                    ...
                    /*TrungHa: add product's name to pdf creditmemo*/
                    ...
                    $itemId = Mage::getModel('giftwrap/selectionitem')->load($selectionId)->getItemId();    
                    
//                    $productName = $creditmemoItem->getName().' - '.(int)$creditmemoItem->getQty().' item(s)';     
//                  
