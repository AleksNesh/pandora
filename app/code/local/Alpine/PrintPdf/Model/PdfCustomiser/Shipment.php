 ...
 */
 ...
 /**
 * class Alpine_PrintPdf_Model_PdfCustomiser_Shipment
 *
 * @category   Alpine
 * @package    Alpine_PrintPdf
 */ 
class Alpine_PrintPdf_Model_PdfCustomiser_Shipment extends Fooman_PdfCustomiser_Model_Shipment
{
    /**
        ...
        foreach ($orderIds as $orderId) {
            ...
            if (count($shipments) > 0 || $shipments->getSize() > 0) {
                foreach ($shipments as $shipment) {
                    ...
                    $giftBoxCollection = Alpine_PrintPdf_Model_PdfCustomiser_Order::getGiftBoxCollection($shipment);
