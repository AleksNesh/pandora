 ...
 */
define('K_PATH_MAIN', Mage::getBaseDir('media') . DS);

/**
 * URL path to tcpdf installation folder (http://localhost/tcpdf/).
 * By default it is automatically set but you can also set it as a fixed string to improve performances.
 */
define('K_PATH_URL', Mage::getBaseUrl('media'));

/**
 * Path for PDF fonts.
 * By default it is automatically set but you can also set it as a fixed string to improve performances.
 */
define('K_PATH_FONTS', Mage::getBaseDir('lib') . DS . 'tcpdf' . DS . 'fonts' . DS);
 ...
 */
define ('K_PATH_CACHE', Mage::getBaseDir('cache') . DS . 'pdfcache' . DS);
