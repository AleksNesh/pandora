...
Product.Bundle.prototype = {
    ...
    changeSelection: function(selection){
        ...
        if (this.config['options'][parts[2]].isMulti) {
            ...
            /**
             * AAI HACK TO QUITE JS ERRORS
             *
             * tierPriceElement was returning `null`
             *
             * (maybe because of jQuery conflict or not specifying
             * if the selector is a class or an id>)
             */
            if (tierPriceElement !== null && tierPriceElement.length > 1) {
